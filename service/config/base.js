...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      "@utils": paths.resolve("src/utils"),
      "@stores": paths.resolve("src/stores"),
      "@directives": paths.resolve("src/directives"),
      "@router": paths.resolve("src/router"),
      "@views": paths.resolve("src/views"),
      "@assets": paths.resolve("src/assets"),
    },
    extensions: [".js", ".jsx", ".vue", ".json", "css", "html"],
  },
